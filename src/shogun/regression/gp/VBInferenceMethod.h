...
#ifndef CVBINFERENCEMETHOD_H_
#define CVBINFERENCEMETHOD_H_
 ...
 *
 */
class CVBInferenceMethod: public CInferenceMethod
{
...
public:
	...
	CVBInferenceMethod(CKernel* kernel, CFeatures* features,
			CMeanFunction* mean, CLabels* labels, CLikelihoodModel* model);

	/*Destructor*/
	virtual ~CVBInferenceMethod();
